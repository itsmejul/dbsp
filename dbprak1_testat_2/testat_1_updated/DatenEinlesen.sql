...
DECLARE
    ...
    cat_name TEXT;
BEGIN
    -- Kategorienamen aus xml extrahieren
    SELECT unnest(xpath('/category/text()', cat::xml))::TEXT INTO cat_name;
    
    -- Neue Kategorie mit neuem namen in tabelle einfügen
    INSERT INTO categories (title, parent_id)
    VALUES (cat_name, parent_id)
    RETURNING id INTO cat_id;

    -- Items, die direkt in der aktuellen Kategorie sind, einfügen
